package com.dms.pmsandroid.presentation.feature.login.ui
...
import com.dms.pmsandroid.databinding.DialogWelcomeBinding
...
class WelcomeDialog : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.welcomeDone.setOnClickListener {
            dismiss()
        }
    }
}