...
class EventDecorator(private val date: String,private val dots:ArrayList<Int>,private val context: Context) : DayViewDecorator {
    ...
    private val red = context.resources.getColor(R.color.red_200)
